...
import 'package:flutter_yim/module_movie/constants/filter_menu.dart';
import 'package:flutter_yim/module_movie/models/state_model/base_state_model.dart';
import 'package:flutter_yim/module_movie/models/state_model/movie_state_model.dart';
...
class FilterStateModel extends BaseStateModel with MovieStateModel {
  ...
  static FilterStateModel of(BuildContext context) =>
      ScopedModel.of<FilterStateModel>(context, rebuildOnChange: true);
}
