...
import 'package:flutter_yim/module_novel/model/chapter.dart';
...
class _ReaderMenuState extends State<ReaderMenu>
          ...
          children: <Widget>[
            Container(
              ...
              child: GestureDetector(
                ...
                child: Image.asset('assets/mod_novel/img/pub_back_gray.png'),
              ),
            ),
            Expanded(child: Container()),
            Container(
              width: 44,
              child: Image.asset('assets/mod_novel/img/read_icon_voice.png'),
            ),
            Container(
              width: 44,
              child: Image.asset('assets/mod_novel/img/read_icon_more.png'),
            ),
          ],
        ),
      ),
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: Container(
              ...
              child: Image.asset(
                  'assets/mod_novel/img/read_icon_chapter_previous.png'),
            ),
          ),
          Expanded(
            child: Slider(
          ...
          GestureDetector(
            ...
            child: Container(
              padding: EdgeInsets.all(20),
              child: Image.asset(
                  'assets/mod_novel/img/read_icon_chapter_next.png'),
            ),
          )
        ],
      ),
  ...
  buildBottomMenus() {
    return Row(
      ...
      children: <Widget>[
        buildBottomItem('目录', 'assets/mod_novel/img/read_icon_catalog.png'),
        buildBottomItem('亮度', 'assets/mod_novel/img/read_icon_brightness.png'),
        buildBottomItem('字体', 'assets/mod_novel/img/read_icon_font.png'),
        buildBottomItem('设置', 'assets/mod_novel/img/read_icon_setting.png'),
      ],
    );
  }
