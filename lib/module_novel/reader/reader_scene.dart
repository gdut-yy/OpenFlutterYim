...
import 'package:flutter_yim/module_novel/reader/article_provider.dart';
import 'package:flutter_yim/module_novel/reader/reader_config.dart';
import 'package:flutter_yim/module_novel/reader/reader_menu.dart';
import 'package:flutter_yim/module_novel/reader/reader_page_agent.dart';
import 'package:flutter_yim/module_novel/reader/reader_utils.dart';
import 'package:flutter_yim/module_novel/reader/reader_view.dart';
      ...
      body: Stack(
        children: <Widget>[
          Positioned(
              ...
              right: 0,
              bottom: 0,
              child: Image.asset('assets/mod_novel/img/read_bg.png',
                  fit: BoxFit.cover)),
          buildPageView(),
          buildMenu(),
        ],
