...
import 'package:flutter_yim/module_novel//app/app_scene.dart';
...
import 'package:flutter_yim/module_novel/model/novel_comment.dart';
import 'package:flutter_yim/module_novel/novel_detail/novel_comment_cell.dart';
import 'package:flutter_yim/module_novel/novel_detail/novel_detail_cell.dart';
import 'package:flutter_yim/module_novel/novel_detail/novel_detail_header.dart';
import 'package:flutter_yim/module_novel/novel_detail/novel_detail_recommend_view.dart';
import 'package:flutter_yim/module_novel/novel_detail/novel_detail_toolbar.dart';
import 'package:flutter_yim/module_novel/novel_detail/novel_summary_view.dart';
      ...
      children: <Widget>[
        Container(
          ...
          child: GestureDetector(
              onTap: back, child: Image.asset('assets/mod_novel/img/pub_back_white.png')),
        ),
        Opacity(
          opacity: navAlpha,
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                Container(
                  width: 44,
                  child: GestureDetector(
                      onTap: back, child: Image.asset('assets/mod_novel/img/pub_back_gray.png')),
                ),
                Expanded(
                  child: Text(
                    novel.name,
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Image.asset('assets/mod_novel/img/detail_write_comment.png'),
                Text('  写书评',
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    NovelSummaryView(novel.introduction, isSummaryUnfold,
                        changeSummaryMaxLines),
                    NovelDetailCell(
                      iconName: 'assets/mod_novel/img/detail_latest.png',
                      title: '最新',
                    ...
                    NovelDetailCell(
                      iconName: 'assets/mod_novel/img/detail_chapter.png',
                      title: '目录',
